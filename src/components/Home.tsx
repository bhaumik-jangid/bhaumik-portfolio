...
export function Home({ theme }: HeroProps) {
  ...
  const connectLinks = [
    ...
    { img: whatsappLogo, link: "https://wa.me/+7678126653" },
    { img: instagramLogo, link: "https://www.instagram.com/your_shadow047/" },
    { img: facebookLogo, link: "https://www.facebook.com/bhaumik.jangid" },
  ];

  const workLinks = [
    { img: githubLogo, link: "https://github.com/bhaumik-jangid" },
    { img: leetcodeLogo, link: "https://leetcode.com/u/bhaumikjangid/" },
  ];

  const [typedRoles, setTypedRoles] = useState("");
  const rolesText = "Full stack Web Developer | Backend Developer | Tech Explorer";
    ...
    <section id="home" className="hero">
      ...
      <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">Bhaumik Jangid</span>
